...
public class ConversionServiceTests
{
    ...
    {
        var result = _service.Convert(1, "meter", "foot");
    ...
    {
        var result = _service.Convert(3.28084, "foot", "meter");
    ...
    {
        var result = _service.Convert(1, "kilogram", "pound");          
    ...
    {
        var result = _service.Convert(2.20462, "pound", "kilogram");
        Assert.Equal(1, result, 4);
    }
